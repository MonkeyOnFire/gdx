...
public class UserIDBase64 {
	...
	public static Integer decoderUserID(String encodedUserID)  {
		...
		try {
			...
			String base64Encoded = new String(Base64.encodeBase64String(realBase64UserID.getBytes()));
	...
	public static String encoderUserID(Integer userID){
		String base64UserIDEncoded = Base64.encodeBase64String((userID + "").getBytes());
		String currentStringBase64Encoded = Base64.encodeBase64String((System.currentTimeMillis() + "").getBytes());
